  ...
  (function () {
    ...
    f.ensureModuleRegistered("SignalsEventValidation", function () {
      return function (g, h, i, j) {
        ...
        (function () {
          "use strict";
          var a = f.getFbeventsModules("SignalsFBEventsLogging"), b = a.logUserError, c = /^[+-]?\d+(\.\d+)?$/,
            d = "number", e = "currency_code", g = {
              AED: 1,
              ARS: 1,
              AUD: 1,
              BOB: 1,
      ...
      return function (g, i, j, k) {
        ...
        (function () {
          ...
          var k = f.getFbeventsModules("SignalsFBEventsParallelFireConfigTypedef"),
            ...
            s = f.getFbeventsModules("SignalsFBEventsLogging"), t = s.logError, u = "global", v = {
              automaticMatching: q,
              openbridge: g,
              batching: p,
              inferredEvents: r,
      ...
      return function (g, i, j, k) {
        ...
        (function () {
          ...
          var a = Object.assign || function (a) {
              ...
              return a
            }, b = f.getFbeventsModules("SignalsEventValidation"), c = f.getFbeventsModules("SignalsFBEventsConfigStore"),
            d = f.getFbeventsModules("SignalsFBEventsEvents"), e = d.configLoaded,
            i = f.getFbeventsModules("SignalsFBEventsFireLock"), j = f.getFbeventsModules("SignalsFBEventsJSLoader");
          d = f.getFbeventsModules("SignalsFBEventsLogging");
          var k = f.getFbeventsModules("SignalsFBEventsOptIn"), o = f.getFbeventsModules("SignalsFBEventsUtils"),
            p = f.getFbeventsModules("signalsFBEventsGetIsIosInAppBrowser"),
            q = f.getFbeventsModules("signalsFBEventsSendEvent"), r = o.each, s = o.keys, t = o.map, u = o.some,
            v = d.logError, w = d.logUserError, x = {
              AutomaticMatching: !0,
              ...
              LocalComputation: !0,
              IABPCMAEBridge: !0
            }, y = {Track: 0, TrackCustom: 4, TrackSingle: 1, TrackSingleCustom: 2, TrackSingleSystem: 3, TrackSystem: 5};
          o = ["InferredEvents", "Microdata"];
          var z = {AutomaticSetup: o}, A = {
          ...
          d = function () {
            ...
            h(d, [{
              key: "optIn", value: function (a, b) {
                ...
                if (typeof b !== "string" || !B(b)) throw new Error('Invalid Argument: "' + b + '" is not a valid opt-in feature');
                B(b) && (this.optIns.optIn(a, b, d), r([b].concat(m(z[b] || [])), function (a) {
                  A[a] && r(A[a], function (a) {
              ...
              key: "consent", value: function (a) {
                a === "revoke" ? this.locks.lockConsent() : a === "grant" ? this.locks.unlockConsent() : w({
                  action: a,
              ...
              key: "trackSingleCustom", value: function (a, b, c, d) {
                return this.trackSingleGeneric(a, b, c, y.TrackSingleCustom, d)
              }
            }, {
              key: "trackSingleSystem", value: function (a, b, c, d) {
                return this.trackSingleGeneric(b, c, d, y.TrackSingleSystem, null, a)
              }
            }, {
              ...
              key: "_argsHasAnyUserData", value: function (a) {
                ...
                a = a.userDataFormFields != null && s(a.userDataFormFields).length > 0;
                return b || a
              }
            }, {
              key: "fire", value: function (a) {
                ...
                var c = this.fbq.getEventCustomParameters(this.getPixel(a.pixelId), a.eventName, a.customData),
              ...
              key: "loadConfig", value: function (a) {
                ...
                (!this.fbq.pendingConfigs || u(this.fbq.pendingConfigs, function (b) {
                  return b === a
                }) === !1) && D(a, this.VERSION, this.RELEASE_SEGMENT != null ? this.RELEASE_SEGMENT : "stable", p() === !0 ? g.location.origin : "")
              }
            }, {
      ...
      return function (g, h, i, j) {
        ...
        (function () {
          ...
          var a = f.getFbeventsModules("SignalsFBEventsUtils"), b = a.isArray, c = a.isInstanceOf, d = a.map,
            e = f.getFbeventsModules("SignalsParamList"), h = f.getFbeventsModules("signalsFBEventsSendGET"),
    ...
    f.ensureModuleRegistered("SignalsFBEventsMobileAppBridge", function () {
      return function (g, h, j, k) {
        ...
        (function () {
          "use strict";
          var a = f.getFbeventsModules("SignalsFBEventsTelemetry"), b = f.getFbeventsModules("SignalsFBEventsUtils"),
            c = b.each, d = "fbmq-0.1", e = {
    ...
    f.ensureModuleRegistered("SignalsFBEventsPluginManager", function () {
      return function (g, j, k, l) {
        ...
        (function () {
          "use strict";
          var a = f.getFbeventsModules("SignalsFBEventsConfigStore"), b = f.getFbeventsModules("SignalsFBEventsEvents"),
            c = b.pluginLoaded, d = f.getFbeventsModules("SignalsFBEventsJSLoader");
      ...
      return function (i, j, k, l) {
        ...
        (function () {
          ...
          var a = f.getFbeventsModules("SignalsFBEventsExperimentsTypedef"),
            ...
            c = f.getFbeventsModules("SignalsFBEventsTypeVersioning"), d = f.getFbeventsModules("SignalsFBEventsTyped"),
            e = d.coerce;
    ...
    f.ensureModuleRegistered("signalsFBEventsSendBatch", function () {
      return function (g, h, i, j) {
        ...
        (function () {
          "use strict";
          var a = f.getFbeventsModules("SignalsFBEventsBatcher"), b = f.getFbeventsModules("SignalsFBEventsLogging"),
            c = b.logError;
          b = f.getFbeventsModules("SignalsFBEventsUtils");
          var d = b.map, e = f.getFbeventsModules("SignalsParamList"),
            h = f.getFbeventsModules("signalsFBEventsSendBeacon"), i = f.getFbeventsModules("signalsFBEventsSendGET"),
    ...
    f.ensureModuleRegistered("signalsFBEventsSendBeacon", function () {
      return function (g, h, i, j) {
        ...
        (function () {
          "use strict";
          var a = f.getFbeventsModules("SignalsFBEventsQE"), b = f.getFbeventsModules("SignalsFBEventsNetworkConfig"),
      ...
      return function (g, h, i, j) {
        ...
        (function () {
          ...
          var a = f.getFbeventsModules("SignalsFBEventsEvents"), b = a.fired, c = a.setEventId,
            ...
            j = f.getFbeventsModules("signalsFBEventsSendBatch"), l = f.getFbeventsModules("signalsFBEventsSendBeacon"),
            m = f.getFbeventsModules("signalsFBEventsSendGET"), n = f.getFbeventsModules("signalsFBEventsSendXHR"),
    ...
    f.ensureModuleRegistered("signalsFBEventsSendXHR", function () {
      return function (g, h, i, j) {
        ...
        (function () {
          "use strict";
          var a = f.getFbeventsModules("SignalsFBEventsNetworkConfig"), b = f.getFbeventsModules("SignalsParamList"),
    ...
    f.ensureModuleRegistered("SignalsFBEventsSetIWLExtractorsEvent", function () {
      return function (g, h, j, k) {
        ...
        (function () {
          "use strict";
          var a = f.getFbeventsModules("SignalsFBEventsBaseEvent"), b = f.getFbeventsModules("SignalsFBEventsUtils"),
            c = b.filter, d = b.map, e = f.getFbeventsModules("signalsFBEventsCoerceParameterExtractors"),
    ...
    f.ensureModuleRegistered("SignalsFBEventsValidateCustomParametersEvent", function () {
      return function (g, h, i, j) {
        ...
        (function () {
          "use strict";
          var a = f.getFbeventsModules("SignalsFBEventsBaseEvent"), b = f.getFbeventsModules("SignalsFBEventsTyped"),
            c = b.coerce, d = b.Typed, e = f.getFbeventsModules("signalsFBEventsCoercePixel");
      ...
      return function (a, b, c, d) {
        ...
        (function () {
          ...
          var c = f.getFbeventsModules("SignalsFBEventsIWLBootStrapEvent"),
            d = f.getFbeventsModules("SignalsFBEventsLogging"),
            g = f.getFbeventsModules("SignalsFBEventsNetworkConfig"), h = f.getFbeventsModules("SignalsFBEventsPlugin"),
            i = f.getFbeventsModules("signalsFBEventsGetIwlUrl"), j = f.getFbeventsModules("signalsFBEventsGetTier"),
            k = d.logUserError, l = /^https:\/\/.*\.facebook\.com$/i, m = "FACEBOOK_IWL_CONFIG_STORAGE_KEY",
  ...
  (function () {
    ...
    f.ensureModuleRegistered("SignalsFBEvents.plugins.opttracking", function () {
      return function (a, b, c, d) {
        ...
        (function () {
          "use strict";
          var b = f.getFbeventsModules("SignalsFBEventsEvents"), c = b.getCustomParameters, d = b.piiAutomatched,
            g = b.piiConflicting, h = b.piiInvalidated, i = f.getFbeventsModules("SignalsFBEventsOptTrackingOptions");
          b = f.getFbeventsModules("SignalsFBEventsPlugin");
          var j = f.getFbeventsModules("SignalsFBEventsProxyState"), k = f.getFbeventsModules("SignalsFBEventsUtils"),
            l = k.some, m = !1;
          ...
          k = new b(function (a, b) {
            ...
            c.listen(function (c) {
              ...
              var g = p(a.disableConfigLoading !== !0, i.CONFIG_LOADING), h = p(n(), i.SUPPORTS_DEFINE_PROPERTY),
                m = p(o(), i.SUPPORTS_SEND_BEACON), q = p(c != null && k[c.id], i.HAS_CONFLICTING_PII),
    ...
    f.ensureModuleRegistered("SignalsFBEvents", function () {
      return function (a, b, c, d) {
        ...
        (function () {
          ...
          var j = f.getFbeventsModules("SignalsFBEventsNetworkConfig"), k = f.getFbeventsModules("SignalsFBEventsQE"),
            l = f.getFbeventsModules("SignalsParamList"), m = f.getFbeventsModules("signalsFBEventsSendEvent"),
            n = f.getFbeventsModules("SignalsFBEventsUtils"), o = f.getFbeventsModules("SignalsFBEventsLogging"),
            p = f.getFbeventsModules("SignalsEventValidation"), q = f.getFbeventsModules("SignalsFBEventsFBQ"),
            r = f.getFbeventsModules("SignalsFBEventsJSLoader"), s = f.getFbeventsModules("SignalsFBEventsFireLock"),
            ...
            y = f.getFbeventsModules("signalsFBEventsCoercePixelID"), z = f.getFbeventsModules("SignalsFBEventsEvents"),
          ...
          var H = z.fired, I = z.getCustomParameters, ba = z.iwlBootstrap, J = z.piiInvalidated,
            ca = z.setIWLExtractors, K = z.validateCustomParameters, L = z.validateUrlParameters, da = o.logError,
            M = o.logUserError, N = s.global, O = -1, ea = Array.prototype.slice, P = Object.prototype.hasOwnProperty,
            Q = c.href, R = !1, fa = !1, S = [], T = {}, ga;
          b.referrer;
          var U = {PageView: new A(), PixelInitialized: new A()}, V = new q(f, T), W = new x(V, N), ha = new A(["eid"]);
          ...
          function pa(a, b, c) {
            ...
            try {
              d.append("ud", a && a.userData || {}, !0), d.append("udff", a && a.userDataFormFields || {}, !0)
            } catch (b) {
              J.trigger(a)
            }
